...
SECRET_KEY = 'b^6@#_-3s#!h(h8=3*lb))%g1c9u!sz3s!y63#(1ghfllpn0pe'
...
LOGIN_REDIRECT_URL = "/seniorProjectApp/redirectme/"

LOGOUT_REDIRECT_URL = '/seniorProjectApp/'

AUTH_USER_MODEL = 'seniorProjectApp.CustomUser' 

# AUTH_PROFILE_MODULE = "account.Users"
